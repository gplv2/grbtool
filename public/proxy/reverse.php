...
$proxy = new CrossProxy(array('https://nm1.bitless.be','reverse.php'));
 ...
 */
   ...
   protected function send_reply() {
      ...
      * */
      ...
      if (!empty($this->debug)) { $this->trace(4, sprintf("%s - Backend headers", __METHOD__), json_encode($this->backend_response_headers)); }
